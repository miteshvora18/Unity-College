<%@ Page Title="" Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="AddExamRelated.aspx.cs" Inherits="OtherPages_AddExamRelated" %>
    ...
    <div>
      <div class="profile">
        <asp:Label ID="lblheader" class="header" runat="server" 
              Text="Add Exam Schedule/Result"></asp:Label>
