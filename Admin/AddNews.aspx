<%@ Page Title="" Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="AddNews.aspx.cs" Inherits="OtherPages_AddNews" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="AdminContent" Runat="Server">
    <div>
     <div class="profile">
        <asp:Label ID="lblheader" class="header" runat="server" Text="Add News"></asp:Label>
...
<br />
        ...
        <table class="style1">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtNewsHeader" runat="server" TextMode="MultiLine"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="txtNewsHeader" ErrorMessage="News Header is required">&nbsp;</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" 
                        CssClass="btnEventRegister" onclick="btnSubmit_Click" />
