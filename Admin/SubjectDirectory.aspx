<%@ Page Title="" Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="SubjectDirectory.aspx.cs" Inherits="OtherPages_SubjectDirectory" %>
...
<div>
    <div class="profile">
        <asp:Label ID="lblheader" class="header" runat="server" Text="Subject Directory"></asp:Label>
...
<br />
    ...
    <div>
        <asp:GridView ID="gvSubjectDirectory" runat="server" 
            onrowcommand="gvSubjectDirectory_RowCommand" CellSpacing="10" 
        ...
        <asp:TemplateField ShowHeader="False" >
            <ItemTemplate> 
                <asp:Button ID="btnEdit" class="btnEventRegister" Width="70px" runat="server" Text="Edit" CommandName="Seen" CommandArgument='<%#Eval("SubjectId") %>'/>
            </ItemTemplate>
        </asp:TemplateField>
        </Columns>
