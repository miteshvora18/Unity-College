<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExamSchedule.aspx.cs" Inherits="ExamSchedule" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ChildPages" Runat="Server">
    ...
    <div style="text-align:center">
        <asp:Label ID="lblExCourseHead" runat="server" BackColor="#CCCC00" 
            ...
            Font-Strikeout="False" ForeColor="#CC0000" Text="Exam Schedule"></asp:Label>
    </div>
