...
public partial class ExamSchedule : System.Web.UI.Page
{
    ...
    /// <summary>
    /// Populates list of courses in drop down list..
    /// </summary>
    ...
    protected void ddlCourse_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            var course = (from c in ue.Courses
                          ...
                          where c.cname == ddlCourse.Text && edt.edtname == "Exam Schedule" && er.ervalid == true
            ...
            if (ddlCourse.SelectedIndex != 0)
            {
                if (ddlSem.SelectedIndex != 0)
                {
                    var currentSemester = (from er in ue.ExamRelated
                                           ...
                                           where c.cname == ddlCourse.Text && er.ersem == sem && edt.edtname == "Exam Schedule"
