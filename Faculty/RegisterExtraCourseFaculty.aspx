<%@ Page Title="" Language="C#" MasterPageFile="Faculty.master" AutoEventWireup="true" CodeFile="RegisterExtraCourseFaculty.aspx.cs" Inherits="OtherPages_RegisterExtraCourseF" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FacultyContent" Runat="Server">
 <div>
    <div>
        <div class="profile">
        <asp:Label ID="lblheader" runat="server" class="header" Text="Register for Extra Course"></asp:Label>
        ...
        <table class="style1">
            ...
            <tr>
                <td>
                    <asp:Label ID="lblStartDate" runat="server" Text="Select Start Date"></asp:Label>
