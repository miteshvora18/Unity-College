<%@ Page Title="" Language="C#" MasterPageFile="Faculty.master" AutoEventWireup="true" CodeFile="RenewExtraCourseFaculty.aspx.cs" Inherits="OtherPages_RenewExtraCourseS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FacultyContent" Runat="Server">
    <div>
        <div class="profile">
        <asp:Label ID="lblheader" runat="server" class="header" Text="Renew Extra Course"></asp:Label>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlExtraCourse" runat="server" AutoPostBack="True" 
                        onselectedindexchanged="ddlExtraCourse_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
