<%@ Page Title="" Language="C#" MasterPageFile="Student.master" AutoEventWireup="true" CodeFile="EditEventStudent.aspx.cs" Inherits="OtherPages_EditEvent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="StudentContent" Runat="Server">
    <div>
    <div class="profile">
        <asp:Label ID="lblheader" runat="server" class="header" Text="Edit Event"></asp:Label>
