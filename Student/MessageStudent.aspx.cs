...
public partial class OtherPages_Message : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string facultyUsername = Request.QueryString["facultyusername"];
            ...
            #region Make messages that are unread as read for message from specific faculty..
            var readMsg = (from cf in ue.CommunicateFaculty
                           join u in ue.Users
                           on cf.Users2.uid equals u.uid
                           join u2 in ue.Users
                           on cf.Users1.uid equals u2.uid
                           where cf.cfunread == true && cf.Users2.username == currentUser && cf.Users1.username == facultyUsername
                           select cf).ToList();
            if (readMsg.Count != 0)
            {
            ...
            //Get previous communication between student and faculty..
            if (!IsPostBack)
            {
                PrevMsg();
            }
    ...
    protected void btnSend_Click(object sender, EventArgs e)
    {
        try
        {
            string student = (string)Session["username"];
            string faculty = Request.QueryString["facultyusername"];
            ...
            if (txtSend.Text != "")
            {
                ...
                cf.Users1Reference.EntityKey = new System.Data.EntityKey("unitycollegeEntities1.Users", "uid", studentUser.uid);
                cf.Users2Reference.EntityKey = new System.Data.EntityKey("unitycollegeEntities1.Users", "uid", facultyUser.uid);
    ...
    /// <summary>
    /// Retrieves prev messages between student and faculty
    /// </summary>
    public void PrevMsg()
    {
        try
        {
            ...
            {
                lblPrevMsg.Text = "";
                string studentUsername = (string)Session["username"];
                string facultyUsername = Request.QueryString["facultyusername"];

                var faculty = (from u in ue.Users
                               where u.username == facultyUsername
                               select u).FirstOrDefault();

                lblFaculty.Text = faculty.uFullname;
                ...
                if (prevMsg.Count != 0)
                {
                    ...
                    {
                        if (data.u1.username == studentUsername)
                        ...
                        else if (data.u1.username == facultyUsername)
