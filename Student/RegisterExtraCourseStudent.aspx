<%@ Page Title="" Language="C#" MasterPageFile="Student.master" AutoEventWireup="true" CodeFile="RegisterExtraCourseStudent.aspx.cs" Inherits="OtherPages_RegisterExtraCourseS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="StudentContent" Runat="Server">
    ...
    <div>
     <div class="profile">
        <asp:Label ID="lblheader" class="header" runat="server" Text="Register for Extra Course"></asp:Label>
